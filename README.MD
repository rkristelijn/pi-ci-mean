...
Todo: Update Jessie (8) to Stretch (9). Debian name their releases after [Pixar](https://www.debian.org/doc/manuals/project-history/ch-releases.en.html) characters.
